...
var Scroller2 = new Class({
	...
	initialize: function(element, options){
		this.setOptions(options);
		this.element = $(element);
		this.id_right_arrows_div = $(options.id_right_arrows_div);
		this.mousemover = ([window, document].contains(options.id_right_arrows_div)) ? $(document.body) : this.id_right_arrows_div;
	},
